(function(g){var window=this;'use strict';var Hhb=function(a,b){g.W.call(this,{G:"button",La:["ytp-miniplayer-expand-watch-page-button","ytp-button","ytp-miniplayer-button-top-left"],Y:{title:"{{title}}","data-tooltip-target-id":"ytp-miniplayer-expand-watch-page-button","aria-keyshortcuts":"i","data-title-no-tooltip":"{{data-title-no-tooltip}}"},X:[{G:"svg",Y:{height:"24px",version:"1.1",viewBox:"0 0 24 24",width:"24px"},X:[{G:"g",Y:{fill:"none","fill-rule":"evenodd",stroke:"none","stroke-width":"1"},X:[{G:"g",Y:{transform:"translate(12.000000, 12.000000) scale(-1, 1) translate(-12.000000, -12.000000) "},
X:[{G:"path",Y:{d:"M19,19 L5,19 L5,5 L12,5 L12,3 L5,3 C3.89,3 3,3.9 3,5 L3,19 C3,20.1 3.89,21 5,21 L19,21 C20.1,21 21,20.1 21,19 L21,12 L19,12 L19,19 Z M14,3 L14,5 L17.59,5 L7.76,14.83 L9.17,16.24 L19,6.41 L19,10 L21,10 L21,3 L14,3 Z",fill:"#fff","fill-rule":"nonzero"}}]}]}]}]});this.I=a;this.Ta("click",this.onClick,this);this.updateValue("title",g.xT(a,"Expand","i"));this.update({"data-title-no-tooltip":"Expand"});g.ob(this,g.rT(b.Fc(),this.element))},Ihb=function(a){g.W.call(this,{G:"div",
S:"ytp-miniplayer-ui"});this.qg=!1;this.player=a;this.T(a,"minimized",this.di);this.T(a,"onStateChange",this.GP)},Jhb=function(a){g.aU.call(this,a);
this.u=new g.MJ(this);this.j=new Ihb(this.player);this.j.hide();g.$S(this.player,this.j.element,4);a.Uf()&&(this.load(),g.eq(a.getRootNode(),"ytp-player-minimized",!0))};
g.x(Hhb,g.W);Hhb.prototype.onClick=function(){this.I.Qa("onExpandMiniplayer")};g.x(Ihb,g.W);g.k=Ihb.prototype;
g.k.GM=function(){this.tooltip=new g.wW(this.player,this);g.I(this,this.tooltip);g.$S(this.player,this.tooltip.element,4);this.tooltip.scale=.6;this.Vc=new g.DU(this.player);g.I(this,this.Vc);this.bk=new g.W({G:"div",S:"ytp-miniplayer-scrim"});g.I(this,this.bk);this.bk.Ha(this.element);this.T(this.bk.element,"click",this.oH);var a=new g.W({G:"button",La:["ytp-miniplayer-close-button","ytp-button"],Y:{"aria-label":"Close"},X:[g.jR()]});g.I(this,a);a.Ha(this.bk.element);this.T(a.element,"click",this.ip);
a=new Hhb(this.player,this);g.I(this,a);a.Ha(this.bk.element);this.Ru=new g.W({G:"div",S:"ytp-miniplayer-controls"});g.I(this,this.Ru);this.Ru.Ha(this.bk.element);this.T(this.Ru.element,"click",this.oH);var b=new g.W({G:"div",S:"ytp-miniplayer-button-container"});g.I(this,b);b.Ha(this.Ru.element);a=new g.W({G:"div",S:"ytp-miniplayer-play-button-container"});g.I(this,a);a.Ha(this.Ru.element);var c=new g.W({G:"div",S:"ytp-miniplayer-button-container"});g.I(this,c);c.Ha(this.Ru.element);this.cX=new g.IV(this.player,
...
La:["ytp-miniplayer-close-button","ytp-button"],Y:{"aria-label":"Close"},X:[g.jR()]});g.I(this,a);a.Ha(this.YG.element);this.T(a.element,"click",this.ip);a=new g.W({G:"button",La:["ytp-miniplayer-replay-button","ytp-button"],Y:{"aria-label":"Close"},X:[g.eDa()]});g.I(this,a);a.Ha(this.YG.element);this.T(a.element,"click",this.b7);this.T(this.player,"presentingplayerstatechange",this.Hd);this.T(this.player,"appresize",this.Hb);this.T(this.player,"fullscreentoggled",this.Hb);this.Hb()};
...
g.k.WA=function(){};
g.k.us=function(){};
g.k.GD=function(){};g.x(Jhb,g.aU);g.k=Jhb.prototype;g.k.onVideoDataChange=function(){if(this.player.getVideoData()){var a=this.player.getVideoAspectRatio(),b=16/9;a=a>b+.1||a<b-.1;g.eq(this.player.getRootNode(),"ytp-rounded-miniplayer-not-regular-wide-video",a)}};
...
g.k.unload=function(){this.player.showControls();this.j.hide()};g.$T("miniplayer",Jhb);})(_yt_player);
